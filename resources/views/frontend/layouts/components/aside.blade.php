    ...
    <div class="h-full pb-4 overflow-y-auto sidebar-color">
        ...
        <div class="bg-gradient-to-r from-gray-800 to-gray-900 p-4 text-white">
            <div class="grid grid-cols-2 gap-4">
                ...
                <!-- Item 1 -->
                <a href="/" tabindex="0"
                    class="flex flex-col items-center space-y-2 p-2 rounded-md bg-gradient-to-r from-pink-200 to-pink-400 transition-transform hover:scale-105">
                    <img src="{{ asset('images/icon_spin.png') }}" alt="" class="w-10 h-10">
                ...
                <!-- Item 2 -->
                <a href="/" tabindex="0"
                    class="flex flex-col items-center space-y-2 p-2 rounded-md bg-gradient-to-r from-green-200 to-green-400 transition-transform hover:scale-105">
                    <img src="{{ asset('images/icon_megaphone.svg') }}" alt="" class="w-10 h-10">
                    <div class="text-center">
                ...
                <!-- Item 3 -->
                <a href="/" tabindex="0"
                    class="flex flex-col items-center space-y-2 p-2 rounded-md bg-gradient-to-r from-blue-200 to-blue-400 transition-transform hover:scale-105">
                    <img src="{{ asset('images/icon_lottery.svg') }}" alt="" class="w-10 h-10">
                    <div class="text-center">
                ...
                <!-- Item 4 -->
                <a href="/" tabindex="0"
                    class="flex flex-col items-center space-y-2 p-2 rounded-md bg-gradient-to-r from-orange-200 to-orange-400 transition-transform hover:scale-105">
                    <img src="{{ asset('images/icon_bonus.svg') }}" alt="" class="w-10 h-10">
                    <div class="text-center">
                ...
                <!-- Item 5 -->
                <a href="/" tabindex="0"
                    class="flex flex-col items-center space-y-2 p-2 rounded-md bg-gradient-to-r from-cyan-200 to-cyan-400 transition-transform hover:scale-105">
                    <img src="{{ asset('images/icon_telegram.svg') }}" alt="" class="w-10 h-10">
                    <div class="text-center">
                ...
                <!-- Item 6 -->
                <a href="/" tabindex="0"
                    class="flex flex-col items-center space-y-2 p-2 rounded-md bg-gradient-to-r from-indigo-200 to-indigo-400 transition-transform hover:scale-105">
                    <img src="{{ asset('images/icon_app.svg') }}" alt="" class="w-10 h-10">
                    <div class="text-center">

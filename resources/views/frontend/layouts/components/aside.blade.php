    ...
    <div class="h-full pb-4 overflow-y-auto sidebar-color">
        ...
        <div class="bg-gradient-to-r from-gray-800 to-gray-900 p-4 text-white">
            <div class="grid grid-cols-2 gap-4">
                ...
                <!-- Item 1 -->
                <a href="/" tabindex="0" class="flex items-center space-x-2 p-4 rounded-md bg-gradient-to-r from-pink-200 to-pink-400 transition-transform hover:scale-105">
                    <div class="text-left">
                ...
                <!-- Item 2 -->
                <a href="/" tabindex="0" class="flex items-center space-x-2 p-4 rounded-md bg-gradient-to-r from-green-200 to-green-400 transition-transform hover:scale-105">
                    <div class="text-left">
                ...
                <!-- Item 3 -->
                <a href="/" tabindex="0" class="flex items-center space-x-2 p-4 rounded-md bg-gradient-to-r from-blue-200 to-blue-400 transition-transform hover:scale-105">
                    <div class="text-left">
                ...
                <!-- Item 4 -->
                <a href="/" tabindex="0" class="flex items-center space-x-2 p-4 rounded-md bg-gradient-to-r from-orange-200 to-orange-400 transition-transform hover:scale-105">
                    <div class="text-left">
                ...
                <!-- Item 5 -->
                <a href="/" tabindex="0" class="flex items-center space-x-2 p-4 rounded-md bg-gradient-to-r from-cyan-200 to-cyan-400 transition-transform hover:scale-105">
                    <div class="text-left">
                ...
                <!-- Item 6 -->
                <a href="/" tabindex="0" class="flex items-center space-x-2 p-4 rounded-md bg-gradient-to-r from-indigo-200 to-indigo-400 transition-transform hover:scale-105">
                    <div class="text-left">

                ...
                <ul>
                    ...
                    <li class="mb-4">
                        <button type="button"
                            ...
                            <div class="flex justify-center text-center self-center items-center"><img
                                    src="/assets/images/refer.webp" alt="" width="38" class="mr-3">
                                Duplique seu saldo</div>
                        </button>
                    </li>
                </ul>
                <div class="grid grid-cols-2 gap-4">
                    <div><a href="/"
                            class="category-active site-menu-item flex flex-col items-center justify-center text-center p-3 rounded-xl"><img
                                src="/assets/images/icons/home.svg" alt="" width="35"><span
                                class="text-[12px] mt-2">Home</span></a></div>
                    <div><a href="/casinos"
                            class="site-menu-item flex flex-col items-center justify-center text-center p-3 rounded-xl"><img
                                src="/assets/images/icons/fortune.svg" alt="" width="35"><span
                                class="text-[12px] mt-2">Cassino</span></a></div>
                </div>
                <div class="mt-4">
                    <div class="grid grid-cols-2 gap-4 mt-4 mb-4"><a href="/casino/provider/all/category/PGSOFT"
                            class="h-20 site-menu-item flex flex-col items-center justify-center text-center p-3 rounded-xl"><img
                                src="/storage/01J30XM1RY4HJEJRPYPD4R2J17.png" alt="" width="35"><span
                                class="text-[12px] mt-2">PGSoft</span></a></div>
                </div>
                <div class="grid grid-cols-2 gap-4">
                    <div><a href="/profile/wallet"
                            class="site-menu-item flex flex-col items-center justify-center text-center p-3 rounded-xl"><img
                                src="/assets/images/icons/wallet-money.svg" alt="" width="35"><span
                                class="text-[12px] mt-2">Carteira</span></a></div>
                    <div><a href="/profile/favorite"
                            class="site-menu-item flex flex-col items-center justify-center text-center p-3 rounded-xl"><img
                                src="/assets/images/icons/folder-favourite.svg" alt="" width="35"><span
                                class="text-[12px] mt-2">Favoritos</span></a></div>
                </div>
                <div class="grid grid-cols-2 gap-4 mt-4">
                    ...
                    <div>
                        <a href="/bonus" class="relative">
                            ...
                            <h1 class="button-title-menu">Bônus</h1>
                        </a>
                    </div>
                </div>
                        ...
                        <a href="#"
                            ...
                            <svg width="17" height="17" viewBox="0 0 17 17" fill="none"
                                ...
                                <path d="M1.18518 6.18176H1.99615" stroke="#8C9099" stroke-miterlimit="10"
                                    stroke-linecap="round"></path>
                                <path d="M6.52948 11.1639L2.07724 12.3775L5.58065 15.8906L6.52948 11.1639Z"
                                    fill="#8C9099"></path>
                                <path d="M15.8879 5.57496L12.3845 2.06989L11.1681 6.52508L15.8879 5.57496Z"
                                    fill="#8C9099"></path>
                            </svg>
                            <span class="ml-3">Indique um amigo</span>
                        </a>
                    </li>
                    <li class="px-3">
                        <a href="#"
                            ...
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                ...
                                <g clip-path="url(#clip0_31_225)">
                                    <path d="M4 8H0V12.9C0 13.9 0.7 14.8 1.7 15C2.9 15.2 4 14.2 4 13V8Z"
                                        fill="#414952"></path>
                            ...
                            <span class="flex-1 ml-3 whitespace-nowrap">Central de Apoio</span>
                        </a>
                    </li>
                </ul>
            </div>

...
<head>
    ...
    <link rel="preload" as="style" href="/build/assets/app-a5287762.css">
    <link rel="stylesheet" href="/build/assets/app-a5287762.css" data-navigate-track="reload">
    <style></style>
    <style></style>
</head>
...
<body color-theme="dark" class="bg-base text-gray-800 dark:text-gray-300 ">
    ...
    @include('frontend.layouts.components.modal')

...
@section('content')
    ...
    <div class="filter cm-content-box box-primary">
        <div class="content-title SlideToolHeader">
            <div class="cpa">
                <i class="fa-solid fa-file-lines me-1"></i>Transaksi Withdraw
            </div>
            <div class="tools">
...
@section('scripts')
    <script>
        function loadTransactions(page = 1) {
            ...
            $.ajax({
                url: '{{ route('backoffice.transactions.withdraw.loadData') }}',
                method: 'GET',
                data: formData,
        ...
        $(document).ready(function() {
            ...
            $('#save-status-btn').click(function() {
                ...
                $.ajax({
                    url: '{{ route('backoffice.transactions.withdraw.updateStatus') }}',
                    method: 'POST',
                    data: formData,
                    headers: {

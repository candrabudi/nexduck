...
@section('content')
    ...
    <div class="filter cm-content-box box-primary">
        <div class="content-title SlideToolHeader">
            <div class="cpa">
                <i class="fa-solid fa-file-lines me-1"></i>Transaksi Bonus
            </div>
            <div class="tools">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editStatusModalLabel">Edit Status Transaks</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="save-status-btn">Simpan Perubahan</button>
                </div>
            </div>
        </div>
    </div>
...
@section('scripts')
    <script>
        function loadTransactions(page = 1) {
            ...
            $.ajax({
                url: '{{ route('backoffice.transactions.bonus.loadData') }}',
                method: 'GET',
                data: formData,
